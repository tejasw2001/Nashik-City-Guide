...
public class hoteluserfav {
    ...
    public hoteluserfav(String add, String desc, String gmlink, String img1, String img2, String img3, String name, String price, String rating) {
        this.add = add;
        this.desc = desc;
        this.gmlink = gmlink;
        this.img1 = img1;
