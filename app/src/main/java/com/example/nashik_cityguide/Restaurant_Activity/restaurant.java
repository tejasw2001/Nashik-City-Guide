...
public class restaurant {
    ...
    public restaurant(String add, String cat1, String cat2, String desc, String gmlink, String img1, String img2, String img3, String name, String rating, String timing) {
        this.add = add;
        this.cat1 = cat1;
        this.cat2 = cat2;
        this.desc = desc;
